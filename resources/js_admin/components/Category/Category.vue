		 	 ...
		 	 <div class="col-md-12">
                ...
                <thead>
                    ...
                    <tr v-for="cat in categories">
                      ...
                      <td>
                        <router-link :to="'/admin/categorie/edit/'+cat.id" class="btn btn-warning"><i class="fa fa-edit"></i></router-link>
                        <a  @click="onDelete(cat.id,cat.name)" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                </thead>
             </table>

<template>
	 <div class="addannonce_free">
       <div class="card_annonce">
            ...
            <p class="card__description">hi sir make your ads more important by<a href="#">here</a><p>
             <form @submit="onsubmit">
                  <div class="form-row">
                         <div class="form-group col-md-6">
                             <label for="title">title</label>
                             <input type="text" v-model="annonce.title" class="form-control" id="title" placeholder="title">
                             <span class="text-danger" v-if="valdation.title !=''">
                                    <span v-for="val in valdation.title">
                                        {{val}}</br>
                                    </span>
                             </span>
                         </div>
                          <div class="form-group col-md-6">
                             ...
                             <input type="text"  v-model="annonce.prix" class="form-control" id="prix" placeholder="prix">
                             <span class="text-danger" v-if="valdation.prix !=''">
                                    <span v-for="val in valdation.prix">
                                        {{val}}</br>
                                    </span>
                             </span>
                          </div>
                  ...
                  <div class="form-row">
                         ...
                         <div class="form-group col-md-12">
                              ...
                              <span class="text-danger" v-if="valdation.detialle !=''">
                                    <span v-for="val in valdation.detialle">
                                        {{val}}</br>
                                    </span>
                             </span>
                         </div> 
                          <div class="form-group col-md-12">
                              ...
                              <textarea id="description" v-model="annonce.description" class="form-control"></textarea>
                          ...
                          <div class="form-group">
                              <draggable v-model="annonce.images" class="row col-md-12 gallery-item">
                                  <div v-for="(image, index) in annonce.images" :key="index" class="col-md-4 position-relative newbtn">
                                     <button @click="remove(image, index)" type="button" class="btn position-absolute"><i class="fa fa-times" aria-hidden="true"></i>     
                                     </button>
                              ...
                              <div class="col-md-12 mb-4" v-if="!imageEnd">
                                <label for="images" class='newbtn'>
                                    ...
                                    <span class="text-danger" v-if="valdation.images !=''">
                                         <span v-for="val in valdation.images">
                                        {{val}}</br>
                                         </span>
                                    </span>
                                </label>
...
<script type="text/javascript">
   ...
   import {addfreeads} from '../../helpers/auth';
               ...
               if(e.target.files.length > 0) {
                    if(this.annonce.images.length < 6) {
                        ...
                        reader.onloadend = () => {
                            ...
                            this.annonce.images.push({ img:reader.result, isMain: 0 })
                            this.imageRest--
                        }
